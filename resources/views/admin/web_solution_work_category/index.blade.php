    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Work Categories</li>
            </ol>
        </nav>
        <div>
            @if (Auth::user()->can('webSolutionWorkCategoryAdd')) {{-- Adjust permission --}}
...
@include('admin.web_solution_work_category._partial.addModal')
@include('admin.web_solution_work_category._partial.editModal')

@endsection

@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.web_solution_work_category._partial.script')
@endsection