                            ...
                            <div class="row">
                               @if(Auth::user()->id == 1)
                                ...
                                <div class="col-xl-6 col-xxl-6 col-sm-6 mb-3">
                                 ...
                                 <div class="col-xl-6 col-xxl-6 col-sm-6 mb-3">
                <label class="form-label">System White Logo<span class="text-red font-w900">*</span>  </label>
                <input type="file" class="form-control" name="white_logo" id="" placeholder="System White Logo" >
                 <img src="{{ asset('/') }}{{ $panelSettingInfo->white_logo }}" style="height:20px;"/>
            </div>
<div class="col-xl-12 col-xxl-12 col-sm-12 mb-3">
