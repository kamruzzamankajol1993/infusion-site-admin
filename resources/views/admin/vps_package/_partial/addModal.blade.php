<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header"><h1 class="modal-title fs-5" id="addModalLabel">Add New VPS Package</h1><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
        <form id="addForm" method="post" action="{{ route('vpsPage.package.store') }}">
            @csrf
            <div class="modal-body">
                ...
                <div class="mb-3"><label for="addTitle" class="form-label">Package Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="addTitle" class="form-control" placeholder="e.g., NL Browser RDP" required></div>
                <div class="row">
                    <div class="col-md-6 mb-3"><label for="addPriceSubtitle" class="form-label">Price Subtitle <span class="text-danger">*</span></label>
                        <input type="text" name="price_subtitle" id="addPriceSubtitle" class="form-control" value="Starting at" required></div>
                    <div class="col-md-6 mb-3"><label for="addPrice" class="form-label">Price (BDT) <span class="text-danger">*</span></label>
                        <input type="text" name="price" id="addPrice" class="form-control" placeholder="e.g., 300" required></div>
                </div>
                ...
                <hr>
                <div class="row">
                    <div class="col-md-6 mb-3"><label for="addButtonText" class="form-label">Button Text <span class="text-danger">*</span></label>
                        <input type="text" name="button_text" id="addButtonText" class="form-control" value="Buy Now" required></div>
                    <div class="col-md-6 mb-3"><label for="addButtonLink" class="form-label">Button Link <span class="text-danger">*</span></label>
                        <input type="url" name="button_link" id="addButtonLink" class="form-control" value="#" required></div>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="is_stocked_out" value="on" id="addIsStockedOut">
                    <label class="form-check-label" for="addIsStockedOut">
                        Mark as "Stock Out"?
                    </label>
                </div>
            </div>
