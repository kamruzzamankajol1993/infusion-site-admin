...
<style>
    ...
    .sortable-item-content img {
        width: 50px; height: 66px; /* 3:4 Aspect Ratio */
        margin-right: 15px; object-fit: cover; border-radius: 4px;
    }
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            @if (Auth::user()->can('whyChooseUsAdd'))
        ...
        <div class="card-header bg-white">
            ...
            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $activeTab === 'table' ? 'active' : '' }}" href="{{ route('why-choose-us.index', ['tab' => 'table']) }}" id="table-tab">
                        <i data-feather="list" class="me-1" style="width:16px;"></i> Data Table
                    </a>
                </li>
                @if (Auth::user()->can('whyChooseUsUpdate'))
                <li class="nav-item" role="presentation">
                     <a class="nav-link {{ $activeTab === 'reorder' ? 'active' : '' }}" href="{{ route('why-choose-us.index', ['tab' => 'reorder']) }}" id="reorder-tab">
            ...
            <div class="tab-content" id="myTabContent">
                        ...
                        <table class="table table-hover table-bordered align-middle">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sortable" data-column="title" style="width: 55%;">Title</th>
                ...
                <div class="tab-pane fade {{ $activeTab === 'reorder' ? 'show active' : '' }}" id="reorder-tab-pane" role="tabpanel" aria-labelledby="reorder-tab">
                    @if($activeTab === 'reorder')
                        @if($items->isEmpty())
                            <div class="alert alert-info text-center">No items found to reorder. Please add items first.</div>
                        @else
                            ...
                            <ul id="sortableList">
                                ...
                                <li data-id="{{ $item->id }}">
                                    <div class="sortable-item-content">
                                        ...
                                        <img src="{{ $item->image ? asset($item->image) : asset('path/to/default-image.png') }}" alt="{{ $item->title }}">
...
{{-- Include Modals --}}
@include('admin.why_choose_us._partial.addModal')
@include('admin.why_choose_us._partial.editModal')

@endsection

@section('script')
{{-- SortableJS & Summernote JS --}}
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.js"></script>

{{-- Include the AJAX table script --}}
@include('admin.why_choose_us._partial.script')
@endsection