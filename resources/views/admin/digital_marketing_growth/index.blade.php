...
@section('title') Growth Checklist | {{ $ins_name }} @endsection
@section('css')
<style>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Growth Checklist</li>
            </ol>
        </nav>
        <div>
            @if (Auth::user()->can('digitalMarketingGrowthAdd'))
        ...
        <div class="card-header bg-white">
            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $activeTab === 'table' ? 'active' : '' }}" href="{{ route('digital-marketing-growth.index', ['tab' => 'table']) }}" id="table-tab">
                        <i data-feather="list" class="me-1" style="width:16px;"></i> Data Table
                    </a>
                </li>
                @if (Auth::user()->can('digitalMarketingGrowthUpdate'))
                <li class="nav-item" role="presentation">
                     <a class="nav-link {{ $activeTab === 'reorder' ? 'active' : '' }}" href="{{ route('digital-marketing-growth.index', ['tab' => 'reorder']) }}" id="reorder-tab">
...
@include('admin.digital_marketing_growth._partial.addModal')
@include('admin.digital_marketing_growth._partial.editModal')
@endsection
@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.digital_marketing_growth._partial.script')
@endsection