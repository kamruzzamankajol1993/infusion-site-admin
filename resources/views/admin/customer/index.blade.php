...
@section('title') Customers | {{ $ins_name }} @endsection
@section('body')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#addModal" class="btn text-white" style="background-color: var(--primary-color);">
                <i data-feather="plus" class="me-1" style="width:18px; height:18px;"></i> Add New Customer
            </button>
            @endif
        </div>
    </div>
...
@include('admin.customer._partial.addModal')
@include('admin.customer._partial.editModal')
@endsection
@section('script')
@include('admin.customer._partial.script')
@endsection