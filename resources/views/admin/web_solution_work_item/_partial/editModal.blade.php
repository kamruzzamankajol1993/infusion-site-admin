<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header"><h1 class="modal-title fs-5" id="editModalLabel">Edit Portfolio Item</h1><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
        <form id="editForm" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3"><label for="editImage" class="form-label">Image</label>
                    ...
                    <small class="form-text text-muted">Required: 400x300 px. Max: 1MB. Leave blank to keep current.</small>
                    <div class="mt-2"><img id="editImagePreview" src="#" alt="Image Preview" class="img-thumbnail" style="width: 200px; height: 150px; object-fit: cover; display: none;">
                         <span id="editPreviewPlaceholder" class="text-muted" style="display:none;">No Image</span></div></div>
                <div class="mb-3"><label for="editVisitLink" class="form-label">Visit Link <span class="text-danger">*</span></label>
                    <input type="text" id="editVisitLink" name="visit_link" class="form-control" required></div>
            </div>
