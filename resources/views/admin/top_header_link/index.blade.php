...
@section('title')
Manage Top Header Links | {{ $ins_name ?? 'IIFC' }}
@endsection
...
<div class="container-fluid px-4 py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active" aria-current="page">Top Header Links</li>
        </ol>
    </nav>

    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <h5 class="card-title mb-0">Manage Top Header Links</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border">
                            <div class="card-header card-header-custom">
                                <h6 class="mb-0">Header Link 1</h6>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
