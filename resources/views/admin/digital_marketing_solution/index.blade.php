...
<style>
    ...
    .sortable-item-content img {
        width: 50px; height: 50px; margin-right: 15px; object-fit: contain; border-radius: 4px;
    }
...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            @if (Auth::user()->can('digitalMarketingSolutionAdd'))
        ...
        <div class="card-header bg-white">
            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $activeTab === 'table' ? 'active' : '' }}" href="{{ route('digital-marketing-solution.index', ['tab' => 'table']) }}" id="table-tab">
                        <i data-feather="list" class="me-1" style="width:16px;"></i> Data Table
                    </a>
                </li>
                @if (Auth::user()->can('digitalMarketingSolutionUpdate'))
                <li class="nav-item" role="presentation">
                     <a class="nav-link {{ $activeTab === 'reorder' ? 'active' : '' }}" href="{{ route('digital-marketing-solution.index', ['tab' => 'reorder']) }}" id="reorder-tab">
...
@include('admin.digital_marketing_solution._partial.addModal')
@include('admin.digital_marketing_solution._partial.editModal')
@endsection
@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.digital_marketing_solution._partial.script')
@endsection