<script>
    ...
    var routes = {
        ...
        show: id => `{{ route('facebookAds.pricing-package.show', ':id') }}`.replace(':id', id),
        update: id => `{{ route('facebookAds.pricing-package.update', ':id') }}`.replace(':id', id),
        delete: id => `{{ route('facebookAds.pricing-package.destroy', ':id') }}`.replace(':id', id),
