<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header"><h1 class="modal-title fs-5" id="addModalLabel">Add New Care Item</h1><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
        <form id="addForm" method="post" action="{{ route('webSolution.care-item.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                ...
                <div class="mb-3"><label for="addImage" class="form-label">Image <span class="text-danger">*</span></label>
                    ...
                    <small class="form-text text-muted">Required: 100x60 px. Max: 256KB</small>
                    <img id="addImagePreview" src="#" alt="Image Preview" class="img-thumbnail mt-2" style="display:none; width: 100px; height: 60px; object-fit: cover;"></div>
                <div class="mb-3"><label for="addButtonText" class="form-label">Button Text <span class="text-danger">*</span></label>
                    <input type="text" name="button_text" id="addButtonText" class="form-control" value="BOOK NOW &rarr;" required></div>
