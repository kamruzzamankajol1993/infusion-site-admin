...
@php
    ...
    $pageTitle = $entry->title ?? 'Single Source Selection';
@endphp
@section('title')
...
<style>
    .image-preview-box {
        ...
        /* Aspect Ratio 504 / 500 = 1.008 * 100% = 100.8% */
        padding-top: 100.8%; 
        ...
        <div class="col-md-7 col-lg-6">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="card-title mb-0">Manage: {{ $pageTitle }} (Entry 1)</h5>
                </div>
                <div class="card-body">
                    @include('flash_message')
                    
                    <form action="{{ route('singleSourceSelection.storeOrUpdate') }}" method="POST" enctype="multipart/form-data" novalidate id="imageForm">
                        @csrf
                        ...
                        {{-- ADD THIS NEW BLOCK for Sort Description --}}
                        <div class="mb-3">
