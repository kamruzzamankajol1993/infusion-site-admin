...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            @if (Auth::user()->can('graphicDesignChecklistAdd'))
        ...
        <div class="card-header bg-white">
            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $activeTab === 'table' ? 'active' : '' }}" href="{{ route('graphicDesign.checklist.index', ['tab' => 'table']) }}" id="table-tab">
                        <i data-feather="list" class="me-1" style="width:16px;"></i> Data Table
                    </a>
                </li>
                @if (Auth::user()->can('graphicDesignChecklistUpdate'))
                <li class="nav-item" role="presentation">
                     <a class="nav-link {{ $activeTab === 'reorder' ? 'active' : '' }}" href="{{ route('graphicDesign.checklist.index', ['tab' => 'reorder']) }}" id="reorder-tab">
...
@include('admin.graphic_design_checklist._partial.addModal')
@include('admin.graphic_design_checklist._partial.editModal')

@endsection

@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.graphic_design_checklist._partial.script')
@endsection