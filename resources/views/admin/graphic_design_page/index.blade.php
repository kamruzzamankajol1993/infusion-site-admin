...
@section('title')
Graphic Design Page Content | {{ $ins_name }}
@endsection
...
<div class="container-fluid px-4 py-4">
    ...
    <form action="{{ route('graphicDesign.page.storeOrUpdate') }}" method="POST" enctype="multipart/form-data" novalidate id="contentForm">
        @csrf
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white"><h5 class="card-title mb-0">Intro Section ("360° Marketing")</h5></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white"><h5 class="card-title mb-0">Consultant Section ("Why Your Business Needs")</h5></div>
            <div class="card-body">
                <div class="mb-3"><label for="consultant_title" class="form-label">Title <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="consultant_title" name="consultant_title" value="{{ old('consultant_title', $content->consultant_title ?? '') }}" required></div>
                <div class="mb-3"><label for="consultant_description" class="form-label">Description <span class="text-danger">*</span></label>
                    <textarea class="form-control summernote" id="consultant_description" name="consultant_description" required>{{ old('consultant_description', $content->consultant_description ?? '') }}</textarea></div>
                <div class="mb-3"><label for="consultant_button_text" class="form-label">Button Text <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="consultant_button_text" name="consultant_button_text" value="{{ old('consultant_button_text', $content->consultant_button_text ?? '') }}" required></div>
            </div>
        </div>

        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white"><h5 class="card-title mb-0">Checklist Section ("How We Help You Grow")</h5></div>
            <div class="card-body">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white"><h5 class="card-title mb-0">"Marketing Solutions" Section</h5></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3"><label for="solutions_subtitle" class="form-label">Subtitle <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="solutions_subtitle" name="solutions_subtitle" value="{{ old('solutions_subtitle', $content->solutions_subtitle ?? '') }}" required></div>
                    <div class="col-md-6 mb-3"><label for="solutions_title" class="form-label">Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="solutions_title" name="solutions_title" value="{{ old('solutions_title', $content->solutions_title ?? '') }}" required></div>
                    <div class="col-md-12 mb-3"><label for="solutions_description" class="form-label">Description <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="solutions_description" name="solutions_description" rows="3" required>{{ old('solutions_description', $content->solutions_description ?? '') }}</textarea></div>
                </div>
            </div>
        </div>
