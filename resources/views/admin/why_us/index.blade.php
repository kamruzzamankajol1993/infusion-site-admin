...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            @if (Auth::user()->can('whyUsAdd')) {{-- Permission Check --}}
            <button type="button" data-bs-toggle="modal" data-bs-target="#addWhyUsModal" class="btn text-white" style="background-color: var(--primary-color); white-space: nowrap;">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
             <h5 class="card-title mb-0">All "Why Us" Items</h5>
        </div>
        <div class="card-body">
...
{{-- Hidden Delete Form --}}
    <form id="delete-why-us-form" action="" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
    
{{-- Include Modals --}}
@include('admin.why_us._partial.addModal')
@include('admin.why_us._partial.editModal')

@endsection

@section('script')
{{-- Include the AJAX table script --}}
@include('admin.why_us._partial.script')
@endsection