...
@section('title')
Web Solution Checklist | {{ $ins_name }}
@endsection
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Why Choose Us (List)</li>
            </ol>
        </nav>
        <div>
            @if (Auth::user()->can('webSolutionChecklistAdd')) {{-- Adjust permission --}}
        ...
        <div class="card-header bg-white">
            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $activeTab === 'table' ? 'active' : '' }}" href="{{ route('webSolution.checklist.index', ['tab' => 'table']) }}" id="table-tab">
                        <i data-feather="list" class="me-1" style="width:16px;"></i> Data Table
                    </a>
                </li>
                @if (Auth::user()->can('webSolutionChecklistUpdate')) {{-- Adjust permission --}}
                <li class="nav-item" role="presentation">
                     <a class="nav-link {{ $activeTab === 'reorder' ? 'active' : '' }}" href="{{ route('webSolution.checklist.index', ['tab' => 'reorder']) }}" id="reorder-tab">
                        ...
                        <table class="table table-hover table-bordered align-middle">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sortable" data-column="title" style="width: 70%;">Title</th>
...
@include('admin.web_solution_checklist._partial.addModal')
@include('admin.web_solution_checklist._partial.editModal')

@endsection

@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.web_solution_checklist._partial.script')
@endsection