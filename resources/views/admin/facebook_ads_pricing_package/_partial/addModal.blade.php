        ...
        <form id="addForm" method="post" action="{{ route('facebookAds.pricing-package.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3"><label for="addTitle" class="form-label">Package Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="addTitle" class="form-control" placeholder="e.g., $01 Daily Spend" required></div>
                <div class="row">
                    <div class="col-md-6 mb-3"><label for="addPrice" class="form-label">Price <span class="text-danger">*</span></label>
                        <input type="text" name="price" id="addPrice" class="form-control" placeholder="e.g., 150" required></div>
                    <div class="col-md-6 mb-3"><label for="addPriceSuffix" class="form-label">Price Suffix</label>
                        <input type="text" name="price_suffix" id="addPriceSuffix" class="form-control" placeholder="e.g., Per Ad/USD"></div>
                </div>
