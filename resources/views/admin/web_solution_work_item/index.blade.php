...
@section('title') Work Portfolio Items | {{ $ins_name }} @endsection
@section('css')
<style>
    ...
    .sortable-item-content img { width: 100px; height: 75px; margin-right: 15px; object-fit: cover; border-radius: 4px; }
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Work Portfolio Items</li>
            </ol>
        </nav>
        <div>
            @if (Auth::user()->can('webSolutionWorkItemAdd'))
        ...
        <div class="card-body">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade {{ $activeTab === 'table' ? 'show active' : '' }}" id="table-tab-pane" role="tabpanel" aria-labelledby="table-tab">
                    <div class="d-flex justify-content-end mb-3"><div class="input-group" style="width: 250px;"><input type="text" class="form-control" id="searchInput" placeholder="Search by category..."><span class="input-group-text"><i data-feather="search" style="width:16px;"></i></span></div></div>
                        ...
                        <table class="table table-hover table-bordered align-middle">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sortable" data-column="category_id" style="width: 40%;">Category</th>
                        ...
                        <ul id="sortableList">
                            ...
                            <li data-id="{{ $item->id }}">
                                <div class="sortable-item-content">
                                    ...
                                    <div><strong>{{ $item->category->name ?? 'Uncategorized' }}</strong></div>
                                </div>
...
@include('admin.web_solution_work_item._partial.addModal')
@include('admin.web_solution_work_item._partial.editModal')
@endsection
@section('script')
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
@include('admin.web_solution_work_item._partial.script')
@endsection