<script>
    ...
    var canUpdate = @json(Auth::user()->can('webSolutionCareItemUpdate'));
    ...
    function fetchData() {
        $.get(routes.fetch, { page: currentPage, search: searchTerm, sort: sortColumn, direction: sortDirection }, res => {
            ...
            res.data.forEach((item, i) => {
                let img = `<img src="${routes.assetBase}${item.image}" alt="${item.title}" style="width: 100px; height: 60px; object-fit: cover;">`;
